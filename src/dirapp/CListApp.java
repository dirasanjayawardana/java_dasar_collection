...
public class CListApp {
    public static void main(String[] args){
        ...
        // LinkedList lebih cepat ketika add data dan remove data
        // namun lebih lambat ketika get data dan set data karena harus membaca data satu persatu, dibandingkan dengan ArrayList yang menggunakan index
